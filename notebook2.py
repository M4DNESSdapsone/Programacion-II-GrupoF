...
#crear ventana principal <3 D0M¡N¡QUE <3
...
def registrar_Paciente():
    paciente={
        ...
        "Edad": edad.get(),
        "Genero": genero.get(),
        "Grupo Sanguineo": entryLabelGrupoSanginineo.get(),
...
#boton registrar
btn_registrar=tk.Button(btn_frame, text="Registrar", command= registrar_Paciente, bg="lightblue")
